...
export default function SystemScreen({ navigation }: SystemScreenProps) {
  ...
  const [profileProvider, setProfileProvieder] =
  ...
  const handleSignOut = async () => {
    try {
      ...
      // RootStack을 AuthStack으로 리셋하고, AuthStack 내에서 Welcome 화면으로 이동
  ...
  return (
    <View style={styles.safeArea}>
      <SubHeaderBar title="설정" handleBackPress={navigation.goBack} />
      <ScrollView
        horizontal={false}
